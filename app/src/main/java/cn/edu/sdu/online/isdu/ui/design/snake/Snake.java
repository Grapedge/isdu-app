package cn.edu.sdu.online.isdu.ui.design.snake;
...
import cn.edu.sdu.online.isdu.ui.design.snake.animation.AnimationFactory;
...
import cn.edu.sdu.online.isdu.ui.design.snake.annotations.PrimaryConstructor;
import cn.edu.sdu.online.isdu.ui.design.snake.annotations.SetDragParameter;
import cn.edu.sdu.online.isdu.ui.design.snake.app.AppFragment;
import cn.edu.sdu.online.isdu.ui.design.snake.app.Fragment;
import cn.edu.sdu.online.isdu.ui.design.snake.config.SnakeConfigException;
import cn.edu.sdu.online.isdu.ui.design.snake.config.SnakeConfigReader;
import cn.edu.sdu.online.isdu.ui.design.snake.util.ActivityDragInterceptor;
import cn.edu.sdu.online.isdu.ui.design.snake.util.ActivityManager;
import cn.edu.sdu.online.isdu.ui.design.snake.util.FragmentManagerHelper;
import cn.edu.sdu.online.isdu.ui.design.snake.util.GlobalActivityLifecycleDelegate;
import cn.edu.sdu.online.isdu.ui.design.snake.util.Logger;
import cn.edu.sdu.online.isdu.ui.design.snake.util.SoftKeyboardHelper;
...
public class Snake {
    ...
    public static <T extends android.app.Fragment> T newProxy(Class<? extends T> fragment, Object... args) {
        ...
        try {
            ...
            if(AppFragment.class.isAssignableFrom(fragment)) {
    ...
    public static void enableDragToClose(@NonNull android.app.Fragment fragment, boolean enable) {
        if(fragment instanceof AppFragment) {
            ((AppFragment) fragment).enableDragToClose(enable);
        } else {
            try {
                ...
                if (e instanceof NoSuchMethodException) {
                    throw new SnakeConfigException("Plase use Snake.newProxy create a AppFragment instance");
                } else {
                    e.printStackTrace();
                }
            }
    ...
    public static void enableDragToClose(@NonNull android.support.v4.app.Fragment fragment, boolean enable) {
        if(fragment instanceof Fragment) {
            ...
            try {
                ...
                if (e instanceof NoSuchMethodException) {
                    throw new SnakeConfigException("Plase use Snake.newProxySupport create a AppFragment instance");
                } else {
                    e.printStackTrace();
                }
            }
    ...
    public static void addDragListener(@NonNull android.app.Fragment fragment, Snake.OnDragListener onDragListener) {
        if(fragment instanceof AppFragment) {
            ((AppFragment) fragment).addOnDragListener(onDragListener);
        } else {
            try {
    ...
    public static void setCustomTouchInterceptor(@NonNull android.app.Fragment fragment, SnakeTouchInterceptor interceptor) {
        if(fragment instanceof AppFragment) {
            ((AppFragment) fragment).setCustomTouchInterceptor(interceptor);
        } else {
            try {
    ...
    public static void enableSwipeUpToHome(@NonNull android.app.Fragment fragment, boolean enable) {
        if(fragment instanceof AppFragment) {
            ((AppFragment) fragment).enableSwipeUpToHome(enable);
        } else {
            try {
                ...
                if (e instanceof NoSuchMethodException) {
                    throw new SnakeConfigException("Please use Snake.newProxy create a AppFragment instance");
                } else {
                    e.printStackTrace();
                }
            }
    ...
    public static void enableSwipeUpToHome(@NonNull android.support.v4.app.Fragment fragment, boolean enable) {
        if(fragment instanceof Fragment) {
            ...
            try {
                ...
                if (e instanceof NoSuchMethodException) {
                    throw new SnakeConfigException("Please use Snake.newProxySupport create a AppFragment instance");
                } else {
                    e.printStackTrace();
                }
            }
