...
class CreateLostAndFoundPostActivity : NormActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_create_lost_and_found_post)
...
//            val obj = org.json.JSONObject()
    ...
    private fun loadDraft() {
        val spp = getSharedPreferences("post_draft", Context.MODE_PRIVATE)
        val string = spp.getString("content", "")
        val title = spp.getString("title", "")
                    ...
                    Luban.with(this)
                            ...
                            .setCompressListener(object : OnCompressListener {
                                ...
                                override fun onError(e: Throwable?) {
                                    Logger.log(e)
                                    runOnUiThread {
                                        Toast.makeText(this@CreateLostAndFoundPostActivity, "插入图片失败",
                                ...
                                override fun onStart() {
                                    runOnUiThread {
                                        dialog = ProgressDialog(this@CreateLostAndFoundPostActivity)
